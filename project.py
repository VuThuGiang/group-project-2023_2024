...
def print_transformation_details(source_filename, target_filename, transformation_icp, source_normals, target_normals):
    ...
    print("\nMa trận Biến Đổi:")
    print(np.array2string(transformation_icp, precision=6, separator=',', suppress_small=True))

    print("\nTransformation Matrix:")
    print(np.array2string(translation, precision=6, separator=',', suppress_small=True))

    print("\nRotation Matrix:")
    print(np.array2string(rotation_matrix, precision=6, separator=',', suppress_small=True))
    ...
    print("\nEuler angle (Degree):")
    print(np.array2string(euler_angles, precision=6, separator=',', suppress_small=True))
...
def plot_fitness_values(all_fitness_values):
    ...
    for pair_index in range(num_pairs):
        plt.plot(range(num_iterations), all_fitness_values[pair_index], label="")
